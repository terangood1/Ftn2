...
BEGIN_MESSAGE_MAP(CFtn2View, CView)
	...
	ON_WM_MOUSEMOVE()
	ON_COMMAND(ID_ETC_COLOR, &CFtn2View::OnEtcColor)
	ON_COMMAND(ID_SIZE_1, &CFtn2View::OnSize1)
	ON_COMMAND(ID_SIZE_20, &CFtn2View::OnSize20)
	ON_COMMAND(ID_SIZE_40, &CFtn2View::OnSize40)
	ON_COMMAND(ID_SIZE_100, &CFtn2View::OnSize100)
END_MESSAGE_MAP()
